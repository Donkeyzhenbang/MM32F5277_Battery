...
void pit_enable (pit_index_enum pit_n)
{
    switch(pit_n)
    {
        case TIM1_PIT:  TIM_Start((TIM_Type *) TIM1);   break;
        case TIM2_PIT:  TIM_Start((TIM_Type *) TIM2);   break;
        case TIM3_PIT:  TIM_Start((TIM_Type *) TIM3);   break;
        case TIM4_PIT:  TIM_Start((TIM_Type *) TIM4);   break;
        case TIM5_PIT:  TIM_Start((TIM_Type *) TIM5);   break;
        case TIM6_PIT:  TIM_Start((TIM_Type *) TIM6);   break;
        case TIM7_PIT:  TIM_Start((TIM_Type *) TIM7);   break;
        case TIM8_PIT:  TIM_Start((TIM_Type *) TIM8);   break;
    }
}
